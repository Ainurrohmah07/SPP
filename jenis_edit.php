...
?>
<h2 style="color: red;">Edit Jenis Pembayaran</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=jenis&aksi=edit" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<label style="color: black;" for="tingkat" class="col-sm-2 control-label">Tingkat</label>
		<div class="col-sm-2">
	...
	<div class="form-group">
		<label style="color: black;" for="jumlah" class="col-sm-2 control-label">Jumlah Nominal</label>
		<div class="col-sm-3">
