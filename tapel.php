...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		echo '<h2 style="color: blue;">Konfigurasi Tahun Pelajaran</h2><hr>';
      echo '<div class="row">';
		...
		echo '<th width="200"><a href="./admin.php?hlm=master&sub=tapel&aksi=baru" class="btn btn-info btn-xs">Tambah Data</a></th></tr>';
