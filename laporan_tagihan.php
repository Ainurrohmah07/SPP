...
if( empty( $_SESSION['iduser'] ) ){
   ...
   echo '<h2 style="color: blue;">Tagihan Pembayaran</h2><hr>';
   echo '<a class="noprint pull-right btn btn-info" onclick="fnCetak()"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak</a>';
