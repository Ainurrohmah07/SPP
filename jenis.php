...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		echo '<h2 style="color: blue;">Jenis Pembayaran</h2><hr>';
      echo '<div class="row">';
		echo '<div class="col-md-7"><table class="table table-bordered">';
		echo '<tr class="info"><th>#</th><th width="200">Tahun Pelajaran</th><th>Tingkat</th><th>Jumlah Nominal</th>';
		echo '<th width="200"><a href="admin.php?hlm=master&sub=jenis&aksi=baru" class="btn btn-info btn-xs">Tambah Data</a></th></tr>';
