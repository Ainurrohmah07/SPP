...
?>
<h2 style="color: red;">Tambah Program Studi</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=jurusan&aksi=baru" class="form-horizontal" role="form">
	<div class="form-group">
		<label style="color: black;" for="idprodi" class="col-sm-2 control-label">Kode Prodi</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" id="idprodi" name="idprodi" placeholder="Kode Prodi" required autofocus>
		</div>
	</div>
	<div class="form-group">
		<label style="color: black;" for="prodi" class="col-sm-2 control-label">Nama Prodi</label>
		<div class="col-sm-4">
