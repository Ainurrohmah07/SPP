  ...
  <body>
	...
	?>
      <form class="form-signin" method="post" action="" role="form">
		...
		?>
        <h2 style="color: red;" class="form-signin-heading"><span class="glyphicon glyphicon-fire"></span> phpBayar</h2>
        <input style="background-color: silver;" type="text" name="username" class="form-control" placeholder="Username" required autofocus>
        <input style="background-color: silver;" type="password" name="password" class="form-control" placeholder="Password" required>
