...
<form class="form-inline" role="form" method="post" action="./admin.php?hlm=bayar">
  ...
  <div class="form-group">
	  ...
	  <?php
		$qkelas = mysql_query("SELECT kelas,th_pelajaran FROM kelas WHERE nis='$nis'");
...
<form class="form-horizontal" role="form" method="post" action="./admin.php?hlm=bayar">
  <div class="form-group">
    <label style="color: black;" for="nis" class="col-sm-2 control-label">Nomor Induk Siswa</label>
    <div class="col-sm-3">
