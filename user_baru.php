...
if( empty( $_SESSION['iduser'] ) ){
	...
	if(isset($_REQUEST['submit'])){
		...
		//form tambah user
?>
<h2 style="color: red;">Tambah User Baru</h2><hr>
<form class="form-horizontal" method="post" action="admin.php?hlm=master&aksi=baru" role="form">
  <div class="form-group">
    <label style="color: black;" for="username" class="col-sm-2 control-label">Username</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="username" name="username" placeholder="Username" required autofocus>
    </div>
  </div>
  <div class="form-group">
    <label style="color: black;" for="password" class="col-sm-2 control-label">Password</label>
    <div class="col-sm-3">
  ...
  <div class="form-group">
    <label style="color: black;" for="fullname" class="col-sm-2 control-label">Fullname</label>
    <div class="col-sm-3">
      <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Fullname">
    </div>
  </div>
  <div class="form-group">
    <label style="color: black;" for="admin" class="col-sm-2 control-label">Admin</label>
    <div class="col-sm-2">
