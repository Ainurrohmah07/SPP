...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		$sql = mysql_query("SELECT kelas.kelas, kelas.th_pelajaran, count(kelas.nis) as jml, siswa.idprodi FROM kelas,siswa WHERE kelas.nis=siswa.nis AND th_pelajaran='2014/2015' GROUP BY kelas.kelas");
		echo '<h2 style="color: blue;">Daftar Kelas</h2><hr>';
      echo '<div class="row">';
		echo '<div class="col-md-7"><table class="table table-bordered">';
		echo '<tr class="info"><th width="50">#</th><th>Kelas</th>';
		echo '<th width="200"><a href="./admin.php?hlm=master&sub=kelas&aksi=view" class="btn btn-info btn-xs">Tambah Data</a></th></tr>';
